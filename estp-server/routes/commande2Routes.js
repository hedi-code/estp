...
const assertBc2Enabled = require("../middleware/assertBc2Enabled");

const router = express.Router();

router.post("/", authMiddleware, assertBc2Enabled, createCommande2);
...
router.put("/:id", authMiddleware, assertBc2Enabled, updateCommande2);
